...
typedef enum {
	...
	SAFI_UNICAST = 1,
	SAFI_MULTICAST = 2,
	SAFI_MPLS_VPN = 3, /* Maps to IANA_SAFI_MPLS_VPN - BGP MPLS-VPN per RFC 4364 / RFC 8277 / RFC 9252 */
	SAFI_ENCAP = 4, /* Maps to IANA_SAFI_ENCAP - Obsolete BGP Encapsulation per RFC 5512 / RFC 9012 */
	SAFI_EVPN = 5, /* Maps to IANA_SAFI_EVPN - BGP EVPN per RFC 7432 */
	SAFI_LABELED_UNICAST = 6, /* Maps to IANA_SAFI_LABELED_UNICAST - BGP-LU per RFC 3107 / RFC 8277 */
	SAFI_FLOWSPEC = 7, /* Maps to IANA_SAFI_FLOWSPEC - Flowspec per RFC 8955 */
	SAFI_BGP_LS = 8, /* Maps to IANA_SAFI_BGP_LS - BGP-LS per RFC 9552 */
	SAFI_MAX = 9
} safi_t;
