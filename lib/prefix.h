...
struct evpn_addr {
	uint8_t route_type;
	union {
		struct evpn_ead_addr _ead_addr; /* Ethernet Auto-Discovery (A-D) route (EVPN Route Type 1) */
		struct evpn_macip_addr _macip_addr; /* MAC/IP Advertisement route (EVPN Route Type 2) */
		struct evpn_imet_addr _imet_addr; /* Inclusive Multicast Ethernet Tag route (EVPN Route Type 3) */
		struct evpn_es_addr _es_addr; /* Ethernet Segment route (EVPN Route Type 4) */
		struct evpn_prefix_addr _prefix_addr; /* IP Prefix route (EVPN Route Type 5) */
	} u;
