...
static const struct zebra_desc_table command_types[] = {
	...
	DESC_ENTRY(ZEBRA_L2VNI_ADD),
	DESC_ENTRY(ZEBRA_L2VNI_DEL),
	DESC_ENTRY(ZEBRA_L3VNI_ADD),
	DESC_ENTRY(ZEBRA_L3VNI_DEL),
	DESC_ENTRY(ZEBRA_EVPN_VNI_INTENT_ADD),
	DESC_ENTRY(ZEBRA_EVPN_VNI_INTENT_DEL),
	DESC_ENTRY(ZEBRA_EVPN_DEFAULT_UNDERLAY_SET),
