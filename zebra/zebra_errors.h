...
enum zebra_log_refs {
	...
	EC_ZEBRA_NETLINK_SRV6_SID_NUMBER_ERROR,
	EC_ZEBRA_PBR_RULE_UPDATE,
	EC_ZEBRA_FPM_ENCODE_FAIL,
	EC_ZEBRA_NETLINK_EXTENDED_ERROR,
	EC_ZEBRA_NETLINK_NO_CONTEXT,
	EC_ZEBRA_NETLINK_EXT_ACK_FAILED,
	EC_ZEBRA_LM_INVALID_REQUEST,
	EC_ZEBRA_NETLINK_MISSING_IFINDEX,
	EC_ZEBRA_NETLINK_INVALID_PREFIX_LEN,
	EC_ZEBRA_INVALID_PREFIX_LEN,
	EC_ZEBRA_RT_SOCKET_INVALID_OP,
	EC_ZEBRA_DPLANE_OP_UNHANDLED,
	EC_ZEBRA_L2_MAC_HASH_CREATE_FAIL,
	EC_ZEBRA_MLAG_DATA_PROCESS_FAIL,
	EC_ZEBRA_PTM_PID_CLIENT_MISMATCH,
	EC_ZEBRA_PTM_COMMAND_TOO_SHORT,
	EC_ZEBRA_PTM_BFD_PID_TRACKING_FAILED,
	EC_ZEBRA_RTADV_WHEEL_DUPLICATE,
	EC_ZEBRA_RTADV_STREAM_OOM,
	EC_ZEBRA_VXLAN_FLOOD_CONTROL_NON_EVPN,
	EC_ZEBRA_GR_DISCONNECT_FAIL,
	EC_ZEBRA_SRV6_ALLOCATION_FAIL,
	EC_ZEBRA_SRV6_LOCATOR_LOOKUP_FAIL,
	EC_ZEBRA_SRV6_INVALID_REQUEST,
	EC_ZEBRA_SRV6_NETLINK_MISSING_ATTR,
	EC_ZEBRA_SRV6_UNSUPPORTED_SEG6LOCAL,
	EC_ZEBRA_SRV6_CTX_ALREADY_ASSOCIATED,
	EC_ZEBRA_SRV6_MANAGER_UNKNOWN_COMMAND,
	EC_ZEBRA_SRV6_LOCATOR_VRF_UNSUPPORTED,
	/* warnings */
