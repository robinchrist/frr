...
DECLARE_MTYPE(BGP_EVPN_EVI_IRT_NODE);
DECLARE_MTYPE(BGP_EVPN_VRF_IRT_NODE);
DECLARE_MTYPE(BGP_EVPN_ROUTE_TARGET);

DECLARE_MTYPE(BGP_SRV6_L3SERVICE);
...
DECLARE_MTYPE(BGP_BP_INSTALL_NODE);
