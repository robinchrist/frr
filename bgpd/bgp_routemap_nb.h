...
int lib_route_map_entry_match_condition_rmap_match_condition_route_distinguisher_create(
...
void lib_route_map_entry_match_condition_rmap_match_condition_route_distinguisher_finish(
	struct nb_cb_apply_finish_args *args);
int lib_route_map_entry_match_condition_rmap_match_condition_route_distinguisher_as2_create(
	struct nb_cb_create_args *args);
int lib_route_map_entry_match_condition_rmap_match_condition_route_distinguisher_as2_destroy(
	struct nb_cb_destroy_args *args);
int lib_route_map_entry_match_condition_rmap_match_condition_route_distinguisher_ipv4_create(
	struct nb_cb_create_args *args);
int lib_route_map_entry_match_condition_rmap_match_condition_route_distinguisher_ipv4_destroy(
	struct nb_cb_destroy_args *args);
int lib_route_map_entry_match_condition_rmap_match_condition_route_distinguisher_as4_create(
	struct nb_cb_create_args *args);
int lib_route_map_entry_match_condition_rmap_match_condition_route_distinguisher_as4_destroy(
	struct nb_cb_destroy_args *args);
int lib_route_map_entry_match_condition_rmap_match_condition_route_distinguisher_field_modify(
	struct nb_cb_modify_args *args);
int lib_route_map_entry_match_condition_rmap_match_condition_route_distinguisher_field_destroy(
	struct nb_cb_destroy_args *args);
...
int lib_route_map_entry_set_action_rmap_set_action_communities_create(struct nb_cb_create_args *args);
int lib_route_map_entry_set_action_rmap_set_action_communities_destroy(struct nb_cb_destroy_args *args);
