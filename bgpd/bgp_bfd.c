...
/*
 * neighbor BFD config-write: converted to northbound, see
 * bgp_cli_write_session_scalars() (bgpd/proteus/bgp_cli_neighbor.c, M4
 * batch B10). The former bgp_bfd_peer_config_write() and all of the
 * "neighbor X bfd ..." DEFUN/DEFPYs below it are retired there.
 */
...
void bgp_bfd_init(struct event_loop *tm)
{
	...
	/* "neighbor X bfd ..." commands converted to northbound, installed by
	 * bgp_cli_neighbor_init() (bgpd/proteus/bgp_cli_neighbor.c, M4 batch
	 * B10).
	 */
}
