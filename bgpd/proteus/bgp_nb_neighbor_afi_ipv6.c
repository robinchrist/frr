...
int instance_neighbor_afi_safis_ipv6_unicast_addpath_rx_modify(
	struct nb_cb_modify_args *args)
{
	return bgp_nb_neighbor_af_flag_modify_invert(args, AFI_IP6, SAFI_UNICAST, PEER_FLAG_DISABLE_ADDPATH_RX);
}
...
int instance_neighbor_afi_safis_ipv6_multicast_addpath_rx_modify(
	struct nb_cb_modify_args *args)
{
	return bgp_nb_neighbor_af_flag_modify_invert(args, AFI_IP6, SAFI_MULTICAST, PEER_FLAG_DISABLE_ADDPATH_RX);
}
...
int instance_neighbor_afi_safis_ipv6_labeled_unicast_addpath_rx_modify(
	struct nb_cb_modify_args *args)
{
	return bgp_nb_neighbor_af_flag_modify_invert(args, AFI_IP6, SAFI_LABELED_UNICAST, PEER_FLAG_DISABLE_ADDPATH_RX);
}
...
{
	return bgp_nb_neighbor_af_flag_modify_invert(args, AFI_IP6, SAFI_MPLS_VPN, PEER_FLAG_DISABLE_ADDPATH_RX);
}
...
int instance_neighbor_afi_safis_ipv6_flowspec_soft_reconfiguration_inbound_modify(
	struct nb_cb_modify_args *args)
{
	return bgp_nb_neighbor_af_flag_modify(args, AFI_IP6, SAFI_FLOWSPEC,
					      PEER_FLAG_SOFT_RECONFIG);
}
