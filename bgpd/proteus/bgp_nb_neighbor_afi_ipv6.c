...
int instance_neighbor_afi_safis_ipv6_unicast_activate_modify(struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-unicast/activate");
...
int instance_neighbor_afi_safis_ipv6_unicast_soo_create(struct nb_cb_create_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-unicast/soo");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_unicast_soo_as2_create(struct nb_cb_create_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-unicast/soo/as2");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-unicast/soo/as2/global-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-unicast/soo/as2/local-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_unicast_soo_as4_create(struct nb_cb_create_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-unicast/soo/as4");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-unicast/soo/as4/global-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-unicast/soo/as4/local-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_unicast_soo_ipv4_create(struct nb_cb_create_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-unicast/soo/ipv4");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-unicast/soo/ipv4/global-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-unicast/soo/ipv4/local-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-unicast/filters/distribute-list-in");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-unicast/filters/distribute-list-out");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-unicast/filters/prefix-list-in");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-unicast/filters/prefix-list-out");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-unicast/filters/filter-list-in");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-unicast/filters/filter-list-out");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-unicast/filters/route-map-in");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-unicast/filters/route-map-out");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-unicast/filters/unsuppress-map");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-unicast/filters/conditional-advertisement/advertise-map");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-unicast/filters/conditional-advertisement/condition");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-unicast/filters/conditional-advertisement/condition-map");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_multicast_activate_modify(struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-multicast/activate");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_multicast_soo_create(struct nb_cb_create_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-multicast/soo");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_multicast_soo_as2_create(struct nb_cb_create_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-multicast/soo/as2");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-multicast/soo/as2/global-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-multicast/soo/as2/local-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_multicast_soo_as4_create(struct nb_cb_create_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-multicast/soo/as4");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-multicast/soo/as4/global-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-multicast/soo/as4/local-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_multicast_soo_ipv4_create(struct nb_cb_create_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-multicast/soo/ipv4");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-multicast/soo/ipv4/global-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-multicast/soo/ipv4/local-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-multicast/filters/distribute-list-in");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-multicast/filters/distribute-list-out");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-multicast/filters/prefix-list-in");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-multicast/filters/prefix-list-out");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-multicast/filters/filter-list-in");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-multicast/filters/filter-list-out");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-multicast/filters/route-map-in");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-multicast/filters/route-map-out");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-multicast/filters/unsuppress-map");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-multicast/filters/conditional-advertisement/advertise-map");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-multicast/filters/conditional-advertisement/condition");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-multicast/filters/conditional-advertisement/condition-map");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_labeled_unicast_activate_modify(struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-labeled-unicast/activate");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_labeled_unicast_soo_create(struct nb_cb_create_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-labeled-unicast/soo");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_labeled_unicast_soo_as2_create(struct nb_cb_create_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-labeled-unicast/soo/as2");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-labeled-unicast/soo/as2/global-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-labeled-unicast/soo/as2/local-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_labeled_unicast_soo_as4_create(struct nb_cb_create_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-labeled-unicast/soo/as4");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-labeled-unicast/soo/as4/global-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-labeled-unicast/soo/as4/local-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_labeled_unicast_soo_ipv4_create(struct nb_cb_create_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-labeled-unicast/soo/ipv4");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-labeled-unicast/soo/ipv4/global-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-labeled-unicast/soo/ipv4/local-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-labeled-unicast/filters/distribute-list-in");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-labeled-unicast/filters/distribute-list-out");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-labeled-unicast/filters/prefix-list-in");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-labeled-unicast/filters/prefix-list-out");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-labeled-unicast/filters/filter-list-in");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-labeled-unicast/filters/filter-list-out");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-labeled-unicast/filters/route-map-in");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-labeled-unicast/filters/route-map-out");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-labeled-unicast/filters/unsuppress-map");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-labeled-unicast/filters/conditional-advertisement/advertise-map");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-labeled-unicast/filters/conditional-advertisement/condition");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-labeled-unicast/filters/conditional-advertisement/condition-map");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_vpn_activate_modify(struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-vpn/activate");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_vpn_soo_create(struct nb_cb_create_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-vpn/soo");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_vpn_soo_as2_create(struct nb_cb_create_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-vpn/soo/as2");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_vpn_soo_as2_global_admin_modify(struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-vpn/soo/as2/global-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_vpn_soo_as2_local_admin_modify(struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-vpn/soo/as2/local-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_vpn_soo_as4_create(struct nb_cb_create_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-vpn/soo/as4");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_vpn_soo_as4_global_admin_modify(struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-vpn/soo/as4/global-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_vpn_soo_as4_local_admin_modify(struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-vpn/soo/as4/local-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_vpn_soo_ipv4_create(struct nb_cb_create_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-vpn/soo/ipv4");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_vpn_soo_ipv4_global_admin_modify(struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-vpn/soo/ipv4/global-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_vpn_soo_ipv4_local_admin_modify(struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-vpn/soo/ipv4/local-admin");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-vpn/filters/distribute-list-in");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-vpn/filters/distribute-list-out");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_vpn_filters_prefix_list_in_modify(struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-vpn/filters/prefix-list-in");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-vpn/filters/prefix-list-out");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_vpn_filters_filter_list_in_modify(struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-vpn/filters/filter-list-in");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-vpn/filters/filter-list-out");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_vpn_filters_route_map_in_modify(struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-vpn/filters/route-map-in");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_vpn_filters_route_map_out_modify(struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-vpn/filters/route-map-out");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
...
int instance_neighbor_afi_safis_ipv6_vpn_filters_unsuppress_map_modify(struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-vpn/filters/unsuppress-map");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-vpn/filters/conditional-advertisement/advertise-map");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-vpn/filters/conditional-advertisement/condition");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
	...
	struct nb_cb_modify_args *args)
{
	...
	case NB_EV_VALIDATE:
		snprintf(args->errmsg, args->errmsg_len, "not yet implemented: %s",
			 "/proteus-bgp:instance/neighbor/afi-safis/ipv6-vpn/filters/conditional-advertisement/condition-map");
		return NB_ERR_VALIDATION;
	case NB_EV_PREPARE:
	case NB_EV_ABORT:
	case NB_EV_APPLY:
