...
{
	return bgp_nb_af_srv6_sid_export_case_modify(args, AFI_IP6, SAFI_UNICAST);
}
...
{
	bgp_nb_af_vpn_label_export_apply_finish(args, AFI_IP6, SAFI_UNICAST);
}
...
void instance_afi_safis_ipv6_flowspec_local_install_apply_finish(struct nb_cb_apply_finish_args *args)
{
	bgp_nb_fs_local_install_apply_finish(args, AFI_IP6, SAFI_FLOWSPEC);
}
