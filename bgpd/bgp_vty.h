...
extern bool bgp_ebgp_requires_policy_default(void);
extern bool bgp_enforce_first_as_default(void);
extern bool bgp_suppress_duplicates_default(void);
extern bool bgp_hard_administrative_reset_default(void);
extern bool bgp_deterministic_med_default(void);
extern bool bgp_network_import_check_default(void);
extern bool bgp_bestpath_aigp_default(void);
extern bool bgp_default_show_hostname_default(void);
extern bool bgp_default_show_nexthop_hostname_default(void);
extern bool bgp_default_software_version_capability_default(void);
extern bool bgp_default_software_version_capability_latest_encoding_default(void);
