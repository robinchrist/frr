...
DEFINE_MTYPE(BGPD, BGP_EVPN_EVI_IRT_NODE, "BGP EVPN EVI Import RT hash table node");
DEFINE_MTYPE(BGPD, BGP_EVPN_VRF_IRT_NODE, "BGP EVPN VRF Import RT hash table node");
DEFINE_MTYPE(BGPD, BGP_EVPN_ROUTE_TARGET, "BGP EVPN Route Target wrapper");

DEFINE_MTYPE(BGPD, BGP_SRV6_L3SERVICE, "BGP prefix-sid SRV6 L3 Service");
