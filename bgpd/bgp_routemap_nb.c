...
const struct frr_yang_module_info frr_bgp_route_map_info = {
	...
	.nodes = {
		...
		},
		{
			...
			.cbs = {
				.modify = lib_route_map_entry_match_condition_rmap_match_condition_aspath_count_modify,
				.destroy = lib_route_map_entry_match_condition_rmap_match_condition_aspath_count_destroy,
			}
		},
		{
		...
		},
		{
			...
			.cbs = {
				.create = lib_route_map_entry_set_action_rmap_set_action_extcommunity_rt_create,
				.destroy = lib_route_map_entry_set_action_rmap_set_action_extcommunity_rt_destroy,
				.apply_finish = lib_route_map_entry_set_action_rmap_set_action_extcommunity_rt_finish,
			}
		},
		{
			.xpath = "/frr-route-map:lib/route-map/entry/set-action/rmap-set-action/frr-bgp-route-map:extcommunity-rt/as2",
			.cbs = {
				.create = lib_route_map_entry_set_action_rmap_set_action_extcommunity_rt_as2_create,
				.destroy = lib_route_map_entry_set_action_rmap_set_action_extcommunity_rt_as2_destroy,
			}
		},
		{
			.xpath = "/frr-route-map:lib/route-map/entry/set-action/rmap-set-action/frr-bgp-route-map:extcommunity-rt/as4",
			.cbs = {
				.create = lib_route_map_entry_set_action_rmap_set_action_extcommunity_rt_as4_create,
				.destroy = lib_route_map_entry_set_action_rmap_set_action_extcommunity_rt_as4_destroy,
			}
		},
		{
			.xpath = "/frr-route-map:lib/route-map/entry/set-action/rmap-set-action/frr-bgp-route-map:extcommunity-rt/ipv4",
			.cbs = {
				.create = lib_route_map_entry_set_action_rmap_set_action_extcommunity_rt_ipv4_create,
				.destroy = lib_route_map_entry_set_action_rmap_set_action_extcommunity_rt_ipv4_destroy,
			}
		},
		{
			.xpath = "/frr-route-map:lib/route-map/entry/set-action/rmap-set-action/frr-bgp-route-map:extcommunity-rt/raw",
			.cbs = {
				.create = lib_route_map_entry_set_action_rmap_set_action_extcommunity_rt_raw_create,
				.destroy = lib_route_map_entry_set_action_rmap_set_action_extcommunity_rt_raw_destroy,
			}
		},
		{
			.xpath = "/frr-route-map:lib/route-map/entry/set-action/rmap-set-action/frr-bgp-route-map:extcommunity-nt",
			.cbs = {
				.create = lib_route_map_entry_set_action_rmap_set_action_extcommunity_nt_create,
				.destroy = lib_route_map_entry_set_action_rmap_set_action_extcommunity_nt_destroy,
				.apply_finish = lib_route_map_entry_set_action_rmap_set_action_extcommunity_nt_finish,
			}
		},
		{
			.xpath = "/frr-route-map:lib/route-map/entry/set-action/rmap-set-action/frr-bgp-route-map:extcommunity-nt/node-id",
			.cbs = {
				.create = lib_route_map_entry_set_action_rmap_set_action_extcommunity_nt_node_id_create,
				.destroy = lib_route_map_entry_set_action_rmap_set_action_extcommunity_nt_node_id_destroy,
			}
		},
		{
			.xpath = "/frr-route-map:lib/route-map/entry/set-action/rmap-set-action/frr-bgp-route-map:extcommunity-nt/raw",
			.cbs = {
				.create = lib_route_map_entry_set_action_rmap_set_action_extcommunity_nt_raw_create,
				.destroy = lib_route_map_entry_set_action_rmap_set_action_extcommunity_nt_raw_destroy,
			}
		},
		{
		...
		},
		{
			...
			.cbs = {
				.create = lib_route_map_entry_set_action_rmap_set_action_extcommunity_color_create,
				.destroy = lib_route_map_entry_set_action_rmap_set_action_extcommunity_color_destroy,
				.apply_finish = lib_route_map_entry_set_action_rmap_set_action_extcommunity_color_finish,
			}
		},
		{
			.xpath = "/frr-route-map:lib/route-map/entry/set-action/rmap-set-action/frr-bgp-route-map:extcommunity-color/color",
			.cbs = {
				.create = lib_route_map_entry_set_action_rmap_set_action_extcommunity_color_color_create,
				.destroy = lib_route_map_entry_set_action_rmap_set_action_extcommunity_color_color_destroy,
			}
		},
		{
			.xpath = "/frr-route-map:lib/route-map/entry/set-action/rmap-set-action/frr-bgp-route-map:extcommunity-color/raw",
			.cbs = {
				.create = lib_route_map_entry_set_action_rmap_set_action_extcommunity_color_raw_create,
				.destroy = lib_route_map_entry_set_action_rmap_set_action_extcommunity_color_raw_destroy,
			}
		},
		{
