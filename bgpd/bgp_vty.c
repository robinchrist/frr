...
void bgp_vty_init(void)
{
	...
	/* neighbor/peer-group lifecycle + remote-as and the peer-group
	 * bind/unbind: fully northbound (bgp_cli_neighbor.c); the legacy
	 * replay-bridge DEFUNs were retired in M9 together with the
